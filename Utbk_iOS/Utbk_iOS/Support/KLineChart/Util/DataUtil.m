...
+(void)addLastData:(NSMutableArray<KLineModel *> *)dataList lastData:(KLineModel *)last {
    if (dataList == nil) {
        return;
    }
    dataList = [NSMutableArray arrayWithArray:[dataList reverseObjectEnumerator].allObjects];
    [dataList addObject:last];
    [self calcMA:dataList isLast:true];
    [self calcBOLL:dataList isLast:true];
    [self calcVolumeMA:dataList isLast:true];
    [self calcKDJ:dataList isLast:true];
    [self calcMACD:dataList isLast:true];
    [self calcRSI:dataList isLast:true];
    [self calcWR:dataList isLast:true];
}
