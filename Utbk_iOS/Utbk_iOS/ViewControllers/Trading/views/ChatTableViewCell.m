...
-(void)refreshCell:(ChatModel *)model
{
    ...
    {
        self.headImageView.frame = CGRectMake(SCREEN_WIDTH - 60, 10, 50, 50);
        self.backView.frame = CGRectMake(SCREEN_WIDTH - 70 - rec.size.width - 20, 10, rec.size.width + 30, rec.size.height + 20);
