...
-(void)RighttouchEvent{
    ...
    [YBPopupMenu showAtPoint:CGPointMake(SCREEN_WIDTH - 32, NavBarHeight - 15) titles:namearray icons:nil menuWidth:130 otherSettings:^(YBPopupMenu *popupMenu) {
...
//        NSLog(@"删除");
        ...
        if ([model.status isEqualToString:@"0"]) {
            //上架广告，可以下架
            [self.view makeToast:LocalizationKey(@"deleteShelvesAdvertiseTip") duration:1.5 position:ToastPosition];
        }else{
            //删除广告
