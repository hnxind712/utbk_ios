...
- (UIView *)naviView{
    if (!_naviView) {
        _naviView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, NavBarHeight)];
        _naviView.backgroundColor = [UIColor whiteColor];
        
        UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, StatusBarHeight, SCREEN_WIDTH, 44)];
        ...
        UIView *bottomLine = [[UIView alloc] initWithFrame:CGRectMake(0, backView.frame.size.height - 1, SCREEN_WIDTH, 1)];
        ...
        for (int i = 0; i < titles.count; i++) {
            ...
            btn.frame = CGRectMake(15 + ((SCREEN_WIDTH - 45) / titles.count) * i + i * 15, 7, (SCREEN_WIDTH - 45) / titles.count, 30);
