...
-(UITableView *)tableView{
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_WIDTH-NavBarHeight-self.tableBottomHeight) style:UITableViewStyleGrouped];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UILabel *leftLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 10,SCREEN_WIDTH-20, 20)];
