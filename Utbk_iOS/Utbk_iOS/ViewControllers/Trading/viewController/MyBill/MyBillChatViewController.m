...
@interface MyBillChatViewController ()<UITableViewDelegate,UITableViewDataSource>
//,chatSocketDelegate>
{
    int _page;
}
...
- (void)keyBoardFrameChanged:(NSNotification* )notification
{
    ...
    if (rect.origin.y == SCREEN_HEIGHT) {
        self.backView.frame = CGRectMake(0, rect.origin.y- 50-NavBarHeight- TabbarSafeBottomMargin, SCREEN_WIDTH, 50);
        
    }else{
        self.backView.frame = CGRectMake(0, rect.origin.y- 50-NavBarHeight, SCREEN_WIDTH, 50);
    }
    //改变表的坐标
    self.tableView.frame = CGRectMake(0, 0, SCREEN_WIDTH,  self.backView.frame.origin.y);
