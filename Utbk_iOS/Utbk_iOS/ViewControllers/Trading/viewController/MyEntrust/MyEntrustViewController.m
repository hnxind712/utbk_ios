...
-(UITableView *)tableView{
    ...
    YLTabBarController*tabbar=(YLTabBarController*)[UIApplication sharedApplication].delegate.window.rootViewController;
        if (tabbar.selectedIndex==2) {
           _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 60, SCREEN_WIDTH, SCREEN_HEIGHT-TabbarSafeBottomMargin-60) style:UITableViewStylePlain];
        }else{
           _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 60, SCREEN_WIDTH, SCREEN_WIDTH-TabbarSafeBottomMargin-NavBarHeight-60) style:UITableViewStylePlain];
        }
...
- (IBAction)touchEvent:(UIButton *)sender {
    ...
    PST_MenuView *menuView = [[PST_MenuView alloc] initWithFrame:CGRectMake(10, NavBarHeight+40, 120, 260) titleArr:self.tradCoinArr imgArr:imageArr arrowOffset:100 rowHeight:50 layoutType:0 directionType:0 delegate:self];
