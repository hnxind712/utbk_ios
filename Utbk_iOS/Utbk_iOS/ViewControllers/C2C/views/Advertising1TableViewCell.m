        ...
        if ([textField.text isEqualToString:@""]) {
            ...
            if ([firstStr isEqualToString:@"."]) {
                ...
                if (textField.text.length == 2) {
                    ...
                    if (array.count >= 3) {
                        [self makeToast:LocalizationKey(@"advertisingCell1Tip1")  duration:1.5 position:ToastPosition];
                        ...
                        if (array.count == 2) {
                            ...
                            if (_index.row == 5 || _index.row == 9) {
                                ...
                                if (titleStr.length > 8) {
                                    [self makeToast:LocalizationKey(@"advertisingCell1Tip2")  duration:1.5 position:ToastPosition];
                                ...
                                if (titleStr.length > 2) {
                                    [self makeToast:LocalizationKey(@"advertisingCell1Tip3") duration:1.5 position:ToastPosition];
...
- (void)textfieldAction:(UITextField *)textField
{
    if (_index.row == 9) {
        ...
        if ([textField.text floatValue] <= 0) {
            textField.text = @"";
            if (_index.row == 6) {
                [self makeToast:LocalizationKey(@"livePriceTip") duration:1.5 position:ToastPosition];
            }
        }
    }
