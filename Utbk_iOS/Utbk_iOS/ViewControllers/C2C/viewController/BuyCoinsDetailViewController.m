...
-(UITableView *)tableView{
    if (!_tableView) {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-TabbarSafeBottomMargin-50-NavBarHeight - 10) style:UITableViewStyleGrouped];
...
-(void)BtnClick:(UIButton *)button{
    ...
    if (button.tag == 1) {
        ...
        [self.navigationController pushViewController:searchVC animated:searchVC];
