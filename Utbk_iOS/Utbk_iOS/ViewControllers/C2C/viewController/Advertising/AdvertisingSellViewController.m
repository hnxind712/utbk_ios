...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = [[ChangeLanguage bundle] localizedStringForKey:@"sellAdvertising" value:nil table:@"Localizable"];
...
//  [self RightsetupNavgationItemWithpictureName:@"helpImage"];
    self.bottomViewHeight.constant = TabbarSafeBottomMargin+10;
...
-(NSArray *)getNameArr{
    NSArray * nameArr = @[[[ChangeLanguage bundle] localizedStringForKey:@"selectCoinType" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"home" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"currencyType" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"Real-timePrice" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"priceType" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"premium" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"tradingPrice" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"minimum" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"maximum" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"sellNum" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"payMethods" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"payTerm" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"moneyPassword" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"isAutoReply" value:nil table:@"Localizable"],@"",@""];
    return nameArr;
}
-(NSArray *)getPlaceHoldArr2{
    NSArray * nameArr = @[@"",@"",@"",[[ChangeLanguage bundle] localizedStringForKey:@"inputReal-timePrice" value:nil table:@"Localizable"],@"",[[ChangeLanguage bundle] localizedStringForKey:@"inputMarketPricePremium" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputTradPrice" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputTradMin" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputTradMax" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputSellAmount" value:nil table:@"Localizable"],@"",[[ChangeLanguage bundle] localizedStringForKey:@"inputPayTerm" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputMoneyPassword" value:nil table:@"Localizable"],@"",@"",@""];
    return nameArr;
}
...
-(NSArray *)judgePlaceHoldArr{
    NSArray * nameArr = @[[[ChangeLanguage bundle] localizedStringForKey:@"inputSelectCoinType" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputSelectHome" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputSelectCurrencyType" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputReal-timePrice" value:nil table:@"Localizable"],@"",[[ChangeLanguage bundle] localizedStringForKey:@"inputMarketPricePremium" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputTradPrice" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputTradMin" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputTradMax" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputSellAmount" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputPayMethods" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputPayTerm" value:nil table:@"Localizable"],[[ChangeLanguage bundle] localizedStringForKey:@"inputMoneyPassword" value:nil table:@"Localizable"],@"",[[ChangeLanguage bundle] localizedStringForKey:@"inputAutoReply" value:nil table:@"Localizable"],@""];
    return nameArr;
}
//MARK:--发布出售广告点击事件
        ...
        if (i ==15 || i==5) {
            ...
            if ([contentStr isEqualToString:@""]) {
                ...
                if ([contentStr floatValue] < 100) {
                    [self.view makeToast:LocalizationKey(@"minimum100") duration:1.5 position:ToastPosition];
                    return;
                }
            }
...
//            NSLog(@"--%@",resPonseObj);
            if (code) {
                if ([resPonseObj[@"code"] integerValue]==0) {
                    //获取数据成功
                    [self.view makeToast:resPonseObj[MESSAGE] duration:1.0 position:ToastPosition];
